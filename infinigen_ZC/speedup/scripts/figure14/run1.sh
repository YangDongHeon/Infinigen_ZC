...
do
  ...
  cp $INFINIGEN_PATH/flex_opt_prefetch_first.py $FLEXGEN_PATH/flexgen/flex_opt.py
  cp $INFINIGEN_PATH/pytorch_backend_prefetch_first.py $FLEXGEN_PATH/flexgen/pytorch_backend.py
  ...
  do
    ...
    #nsys profile -o infinigen_ZC -t cuda,nvtx --force-overwrite true python -m flexgen.flex_opt $CMD
  done
