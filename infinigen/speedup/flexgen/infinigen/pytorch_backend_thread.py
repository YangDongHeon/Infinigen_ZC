...
class TorchDevice:
    ...
    def mha_gen(self, inputs, attention_mask, w_q, b_q, w_k, b_k, w_v, b_v,
                ...
                attn_sparsity, compress_cache, comp_config, p_w_q, partial_k_cache, speculation_stream, alpha, max_num_kv, i, j, k, prefetch_cache_func, gather_worker, attn_layer):
        ...
        if p_w_q is not None:
            with torch.cuda.stream(speculation_stream):
                ...
                #print("ATen is using", torch.get_num_threads(), "CPU threads.")
