...
for SCHEME in "infinigen" #"infinigen_ZC" #"infinigen"
do
  ...
  cp $INFINIGEN_PATH/flex_opt.py $FLEXGEN_PATH/flexgen/flex_opt.py
  ...
  do
    ...
    nsys profile -o infinigen_thread -t cuda,nvtx --force-overwrite true python -m flexgen.flex_opt $CMD
  done
done